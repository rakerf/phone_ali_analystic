 ...
 * FileName: LofWritable
 * Author:   Chenfg
 * Date:     2020/5/20 0020 11:50
 * Description:
 * History:
...
public class LogWritable implements Writable {
    ...
    public void readFields(DataInput dataInput) throws IOException {
        ver = dataInput.readUTF();
        s_time = dataInput.readUTF();
        en = dataInput.readUTF();
        u_ud = dataInput.readUTF();
        u_mid = dataInput.readUTF();
        u_sd = dataInput.readUTF();
        c_time = dataInput.readUTF();
        l = dataInput.readUTF();
        b_iev = dataInput.readUTF();
        b_rst = dataInput.readUTF();
        p_url = dataInput.readUTF();
        p_ref = dataInput.readUTF();
        tt = dataInput.readUTF();
        pl = dataInput.readUTF();
        ip = dataInput.readUTF();
        oid = dataInput.readUTF();
        on = dataInput.readUTF();
        cua = dataInput.readUTF();
        cut = dataInput.readUTF();
        pt = dataInput.readUTF();
        ca = dataInput.readUTF();
        ac = dataInput.readUTF();
        kv_ = dataInput.readUTF();
        du = dataInput.readUTF();
